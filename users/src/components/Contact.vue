<template>
  <div>
    ...
    <div class="a">
      ...
      <div class="c"></div>
      <div class="d"></div>
      <div class="e" style="word-break: break-word;"></div>
      <p class="f" style="text-align: center">WATCHDOGS<br/>
      E-mail:595927593@qq.com<br/>
      phone number:18801342529</p>
    </div>
    <div id="stars"></div>
    <div id="stars2"></div>
    <div id="stars3"></div>
...
html {
height: 100%;
background: radial-gradient(ellipse at bottom, #1b2735 0%, rgb(130 ,172 ,170) 100%);
overflow: hidden;
...
.a {
  ...
  width: 1000px;
  height: 600px;
  background-image: url("../assets/cardbk.jpg");
